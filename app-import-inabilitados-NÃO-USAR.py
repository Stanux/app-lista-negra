...
def criar_tabela_mysql():
    ...
    create_table_query = """
    CREATE TABLE IF NOT EXISTS inabilitados (
...
def capturar_dados_tabela():
    with sync_playwright() as p:
        ...
        # Acessando a página
        page.goto('https://contas.tcu.gov.br/ords/f?p=1660:1:::NO:1::')
...
def inserir_dados_mysql(dados):
    ...
    query = """
    INSERT INTO inabilitados (nome_responsavel, cpf, processo, deliberação, transito_em_julgado, data_final, data_acordao)
    ...
    for dado in dados:
        ...
        valores = (nome_responsavel, cpf, processo, deliberacao, transito_em_julgado, data_final, data_acordao)
